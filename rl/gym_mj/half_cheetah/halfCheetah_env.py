...
def make_HalfCheetah_env(render_mode=None, max_episode_steps=1000):
    """
    创建 Hopper 环境。
...
if __name__ == "__main__":
    # 快速测试：创建环境并运行随机策略
    env = make_HalfCheetah_env(render_mode="human", max_episode_steps=1000)
    get_env_info(env)
